...
/**
 * JamDetails
 * @description Jam detail page with information, nominations, judges, dates, games table, and join/leave actions
 * @returns JSX element with full jam details view
 */
export default function JamDetails({}) {
	...
	const queryGames = useQuery({
		queryKey: [ "jam", id, "games", currentPage ],
		queryFn: async () => {
							...
							columns={[
								...
								},
								{
									...
									render: (
										_,
										data
									) => data?.jam_result?.score?.toFixed(2)
								}
							]}
