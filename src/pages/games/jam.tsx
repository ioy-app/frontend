...
/**
	...
	* @example
	* return <JamBlock />
	* @returns Jam details with voting controls
*/
const JamBlock: React.FC<{
	...
	const query = useQuery({
		...
		queryFn: async () => {
			const response = await games_votes_list(gameId);
			return response;
		}
	});
	...
	const vote = useMutation({
		mutationFn: async ({
			...
			const response = await games_votes_put(gameId, nomination, score);
			return response;
		},
