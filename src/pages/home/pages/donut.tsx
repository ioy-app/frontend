...
/**
 * Donut
 * @description Donut feature page explaining the profile decoration feature with steps and preview
 * @returns JSX element with donut feature description and demo
 */
